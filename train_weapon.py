...
import utils
from dataset.weapondataset import WeaponDataset
...
def main(args):
    ...
    WeaponDataset.TASK = TASK
    dataset = WeaponDataset(args.data_path, get_transform(True))
    dataset_test = WeaponDataset(args.data_path, get_transform(False))
    ...
    accumulation_steps = 8 // args.world_size
    ...
    for epoch in range(args.epochs):
        ...
        train_one_epoch(model, optimizer, data_loader, device, epoch, args.print_freq, accumulation_steps)
        lr_scheduler.step()
        if args.output_dir:
